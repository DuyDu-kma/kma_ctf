...
from KMActf.plugins import init_plugins
from KMActf.utils.crypto import sha256
from KMActf.utils.initialization import (
    init_events,
    init_logs,
...
from KMActf.utils.migrations import create_database, migrations, stamp_latest_revision
from KMActf.utils.sessions import CachingSessionInterface
...
class KMActfRequest(Request):
    ...
    def path(self):
        ...
        :return: string
        """
        return self.script_root + super(KMActfRequest, self).path


class KMActfFlask(Flask):
    def __init__(self, *args, **kwargs):
        ...
        self.request_class = KMActfRequest
    ...
    def create_jinja_environment(self):
        ...
        return super(KMActfFlask, self).create_jinja_environment()
...
def confirm_upgrade():
    if sys.stdin.isatty():
        print("/*\\ KMActf has updated and must update the database! /*\\")
...
def create_app(config="KMActf.config.Config"):
    app = KMActfFlask(__name__)
    with app.app_context():
        ...
        from KMActf.models import (  # noqa: F401
            db,
            Teams,
            Solves,
            Challenges,
        ...
        from KMActf.cache import cache
        ...
        # Upgrading from an older version of KMActf
        ...
        from KMActf.views import views
        from KMActf.teams import teams
        from KMActf.users import users
        from KMActf.challenges import challenges
        from KMActf.scoreboard import scoreboard
        from KMActf.auth import auth
        from KMActf.admin import admin
        from KMActf.api import api
        from KMActf.events import events
        from KMActf.errors import page_not_found, forbidden, general_error, gateway_error
