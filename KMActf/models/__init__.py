...
from KMActf.utils.crypto import hash_password
from KMActf.utils.humanize.numbers import ordinalize
...
class Users(db.Model):
    ...
    @property
    def place(self):
        from KMActf.utils.config.visibility import scores_visible
    ...
    def get_place(self, admin=False, numeric=False):
        """
        This method is generally a clone of KMActf.scoreboard.get_standings.
        The point being that models.py must be self-reliant and have little
        to no imports within the KMActf application as importing from the
        application itself will result in a circular import.
        """
        from KMActf.utils.scores import get_user_standings
...
class Teams(db.Model):
    ...
    def get_place(self, admin=False, numeric=False):
        ...
        application itself will result in a circular import.
        """
        from KMActf.utils.scores import get_team_standings
