...
/******/ 	deferredModules.push(["./KMActf/themes/admin/assets/js/pages/challenge.js","helpers","vendor","default~pages/challenge~pages/configs~pages/editor~pages/main~pages/notifications~pages/pages~pages/~0fc9fcae"]);
...
/***/ "./KMActf/themes/admin/assets/js/challenges/files.js":
/*!*********************************************************!*\
  !*** ./KMActf/themes/admin/assets/js/challenges/files.js ***!
  \*********************************************************/
...
;
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.addFile = addFile;\nexports.deleteFile = deleteFile;\n\nvar _jquery = _interopRequireDefault(__webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\"));\n\nvar _KMActf = _interopRequireDefault(__webpack_require__(/*! core/KMActf */ \"./KMActf/themes/core/assets/js/KMActf.js\"));\n\nvar _helpers = _interopRequireDefault(__webpack_require__(/*! core/helpers */ \"./KMActf/themes/core/assets/js/helpers.js\"));\n\nvar _ezq = __webpack_require__(/*! core/ezq */ \"./KMActf/themes/core/assets/js/ezq.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction addFile(event) {\n  event.preventDefault();\n  var form = event.target;\n  var data = {\n    challenge: CHALLENGE_ID,\n    type: \"challenge\"\n  };\n\n  _helpers.default.files.upload(form, data, function (response) {\n    setTimeout(function () {\n      window.location.reload();\n    }, 700);\n  });\n}\n\nfunction deleteFile(event) {\n  var file_id = (0, _jquery.default)(this).attr(\"file-id\");\n  var row = (0, _jquery.default)(this).parent().parent();\n  (0, _ezq.ezQuery)({\n    title: \"Delete Files\",\n    body: \"Are you sure you want to delete this file?\",\n    success: function success() {\n      _KMActf.default.fetch(\"/api/v1/files/\" + file_id, {\n        method: \"DELETE\"\n      }).then(function (response) {\n        return response.json();\n      }).then(function (response) {\n        if (response.success) {\n          row.remove();\n        }\n      });\n    }\n  });\n}\n\n//# sourceURL=webpack:///./KMActf/themes/admin/assets/js/challenges/files.js?");

/***/ }),

/***/ "./KMActf/themes/admin/assets/js/challenges/flags.js":
/*!*********************************************************!*\
  !*** ./KMActf/themes/admin/assets/js/challenges/flags.js ***!
  \*********************************************************/
/*! no static exports found */
