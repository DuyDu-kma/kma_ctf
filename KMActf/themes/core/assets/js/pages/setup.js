...
function mlcSetup(event) {
  let params = {
    ...
    event_url: window.location.origin + KMActf.config.urlRoot,
    redirect_url: window.location.origin + KMActf.config.urlRoot + "/redirect",
    integration_setup_url:
      window.location.origin + KMActf.config.urlRoot + "/setup/integrations",
