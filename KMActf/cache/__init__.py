...
def clear_config():
    from KMActf.utils import _get_config, get_app_config
...
def clear_standings():
    from KMActf.utils.scores import get_standings, get_team_standings, get_user_standings
    from KMActf.api.v1.scoreboard import ScoreboardDetail, ScoreboardList
...
def clear_pages():
    from KMActf.utils.config.pages import get_page, get_pages
