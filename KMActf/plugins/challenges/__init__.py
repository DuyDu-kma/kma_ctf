...
from KMActf.plugins.flags import get_flag_class
from KMActf.utils.uploads import delete_file
...
class KMActfStandardChallenge(BaseChallenge):
    ...
    def read(challenge):
        ...
        data = {
            ...
            "type": challenge.type,
            "type_data": {
                "id": KMActfStandardChallenge.id,
                "name": KMActfStandardChallenge.name,
                "templates": KMActfStandardChallenge.templates,
                "scripts": KMActfStandardChallenge.scripts,
            },
        }
        return data
...
"""
Global dictionary used to hold all the Challenge Type classes used by KMActf. Insert into this dictionary to register
your Challenge Type.
"""
CHALLENGE_CLASSES = {"standard": KMActfStandardChallenge}
